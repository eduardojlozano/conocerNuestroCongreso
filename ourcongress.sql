...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-07-2021 a las 20:38:32
...
--
-- Base de datos: `ourcongress`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `c0ngr3_commentmeta`
--

CREATE TABLE `c0ngr3_commentmeta` (
...
--
-- Estructura de tabla para la tabla `c0ngr3_comments`
--

CREATE TABLE `c0ngr3_comments` (
...
--
-- Volcado de datos para la tabla `c0ngr3_comments`
--

INSERT INTO `c0ngr3_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
(1, 1, 'Un comentarista de WordPress', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2021-07-25 15:37:15', '2021-07-25 18:37:15', 'Hola, esto es un comentario.\nPara empezar a moderar, editar y borrar comentarios, por favor, visitá la pantalla de comentarios en el escritorio.\nLos avatares de los comentaristas provienen de <a href=\"https://gravatar.com\">Gravatar</a>.', 0, '1', '', 'comment', 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `c0ngr3_links`
--

CREATE TABLE `c0ngr3_links` (
...
--
-- Estructura de tabla para la tabla `c0ngr3_options`
--

CREATE TABLE `c0ngr3_options` (
...
--
-- Volcado de datos para la tabla `c0ngr3_options`
--

INSERT INTO `c0ngr3_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'siteurl', 'http://localhost/conocerNuestroCongreso', 'yes'),
(2, 'home', 'http://localhost/conocerNuestroCongreso', 'yes'),
(3, 'blogname', 'Conocer Nuestro Congreso', 'yes'),
(4, 'blogdescription', 'Otro sitio realizado con WordPress', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'eduardojlozano@gmail.com', 'yes'),
...
(91, 'admin_email_lifespan', '1642790234', 'yes'),
...
(105, 'cron', 'a:4:{i:1627241835;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1627281435;a:4:{s:18:\"wp_https_detection\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1627324635;a:2:{s:30:\"wp_site_health_scheduled_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}', 'yes'),
...
(121, 'https_detection_errors', 'a:1:{s:23:\"ssl_verification_failed\";a:1:{i:0;s:28:\"Falló la verificación SSL.\";}}', 'yes'),
(126, '_site_transient_timeout_theme_roots', '1627240038', 'no'),
...
--
-- Volcado de datos para la tabla `c0ngr3_postmeta`
--

INSERT INTO `c0ngr3_postmeta` (`meta_id`, `post_id`, `meta_key`, `meta_value`) VALUES
...
--
-- Estructura de tabla para la tabla `c0ngr3_posts`
--

CREATE TABLE `c0ngr3_posts` (
...
--
-- Estructura de tabla para la tabla `c0ngr3_terms`
--

CREATE TABLE `c0ngr3_terms` (
...
--
-- Volcado de datos para la tabla `c0ngr3_terms`
--

INSERT INTO `c0ngr3_terms` (`term_id`, `name`, `slug`, `term_group`) VALUES
(1, 'Sin categoría', 'sin-categoria', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `c0ngr3_term_relationships`
--

CREATE TABLE `c0ngr3_term_relationships` (
...
--
-- Volcado de datos para la tabla `c0ngr3_term_relationships`
--

INSERT INTO `c0ngr3_term_relationships` (`object_id`, `term_taxonomy_id`, `term_order`) VALUES
(1, 1, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `c0ngr3_term_taxonomy`
--

CREATE TABLE `c0ngr3_term_taxonomy` (
...
--
-- Volcado de datos para la tabla `c0ngr3_term_taxonomy`
--

INSERT INTO `c0ngr3_term_taxonomy` (`term_taxonomy_id`, `term_id`, `taxonomy`, `description`, `parent`, `count`) VALUES
(1, 1, 'category', '', 0, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `c0ngr3_usermeta`
--

CREATE TABLE `c0ngr3_usermeta` (
...
--
-- Volcado de datos para la tabla `c0ngr3_usermeta`
--

INSERT INTO `c0ngr3_usermeta` (`umeta_id`, `user_id`, `meta_key`, `meta_value`) VALUES
...
(11, 1, 'locale', ''),
(12, 1, 'C0ngr3_capabilities', 'a:1:{s:13:\"administrator\";b:1;}'),
(13, 1, 'C0ngr3_user_level', '10'),
...
--
-- Estructura de tabla para la tabla `c0ngr3_users`
--

CREATE TABLE `c0ngr3_users` (
  `ID` bigint(20) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `c0ngr3_users`
--

INSERT INTO `c0ngr3_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES
(1, 'Developer', '$P$BbLCvFcWH3WS.GvfLXmy3LV0rgc/ut.', 'developer', 'eduardojlozano@gmail.com', 'http://localhost/conocerNuestroCongreso', '2021-07-25 18:37:15', '', 0, 'Developer');
...
--
-- Indices de la tabla `c0ngr3_commentmeta`
--
ALTER TABLE `c0ngr3_commentmeta`
  ADD PRIMARY KEY (`meta_id`),
  ADD KEY `comment_id` (`comment_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Indices de la tabla `c0ngr3_comments`
--
ALTER TABLE `c0ngr3_comments`
...
--
-- Indices de la tabla `c0ngr3_links`
--
ALTER TABLE `c0ngr3_links`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `link_visible` (`link_visible`);

--
-- Indices de la tabla `c0ngr3_options`
--
ALTER TABLE `c0ngr3_options`
  ADD PRIMARY KEY (`option_id`),
  ADD UNIQUE KEY `option_name` (`option_name`),
  ADD KEY `autoload` (`autoload`);

--
-- Indices de la tabla `c0ngr3_postmeta`
--
ALTER TABLE `c0ngr3_postmeta`
  ADD PRIMARY KEY (`meta_id`),
  ADD KEY `post_id` (`post_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Indices de la tabla `c0ngr3_posts`
--
ALTER TABLE `c0ngr3_posts`
  ADD PRIMARY KEY (`ID`),
...
--
-- Indices de la tabla `c0ngr3_termmeta`
--
ALTER TABLE `c0ngr3_termmeta`
  ADD PRIMARY KEY (`meta_id`),
  ADD KEY `term_id` (`term_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Indices de la tabla `c0ngr3_terms`
--
ALTER TABLE `c0ngr3_terms`
  ADD PRIMARY KEY (`term_id`),
  ADD KEY `slug` (`slug`(191)),
  ADD KEY `name` (`name`(191));

--
-- Indices de la tabla `c0ngr3_term_relationships`
--
ALTER TABLE `c0ngr3_term_relationships`
  ADD PRIMARY KEY (`object_id`,`term_taxonomy_id`),
  ADD KEY `term_taxonomy_id` (`term_taxonomy_id`);

--
-- Indices de la tabla `c0ngr3_term_taxonomy`
--
ALTER TABLE `c0ngr3_term_taxonomy`
  ADD PRIMARY KEY (`term_taxonomy_id`),
  ADD UNIQUE KEY `term_id_taxonomy` (`term_id`,`taxonomy`),
  ADD KEY `taxonomy` (`taxonomy`);

--
-- Indices de la tabla `c0ngr3_usermeta`
--
ALTER TABLE `c0ngr3_usermeta`
  ADD PRIMARY KEY (`umeta_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Indices de la tabla `c0ngr3_users`
--
ALTER TABLE `c0ngr3_users`
  ADD PRIMARY KEY (`ID`),
...
--
-- AUTO_INCREMENT de la tabla `c0ngr3_commentmeta`
--
ALTER TABLE `c0ngr3_commentmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_comments`
--
ALTER TABLE `c0ngr3_comments`
  MODIFY `comment_ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_links`
--
ALTER TABLE `c0ngr3_links`
  MODIFY `link_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_options`
--
ALTER TABLE `c0ngr3_options`
  MODIFY `option_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_postmeta`
--
ALTER TABLE `c0ngr3_postmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_posts`
--
ALTER TABLE `c0ngr3_posts`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_termmeta`
--
ALTER TABLE `c0ngr3_termmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_terms`
--
ALTER TABLE `c0ngr3_terms`
  MODIFY `term_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_term_taxonomy`
--
ALTER TABLE `c0ngr3_term_taxonomy`
  MODIFY `term_taxonomy_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_usermeta`
--
ALTER TABLE `c0ngr3_usermeta`
  MODIFY `umeta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `c0ngr3_users`
--
ALTER TABLE `c0ngr3_users`
